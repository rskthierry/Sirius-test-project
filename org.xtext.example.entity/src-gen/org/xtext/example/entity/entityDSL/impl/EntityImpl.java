...
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity
{
  ...
  public Entity getParent()
  {
    if (parent != null && parent.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EntityDSLPackage.ENTITY__PARENT, oldParent, parent));
      }
    }
    return parent;
  }
  ...
  public void setParent(Entity newParent)
  {
    ...
    parent = newParent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EntityDSLPackage.ENTITY__PARENT, oldParent, parent));
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, EntityDSLPackage.ENTITY__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EntityDSLPackage.ENTITY__ATTRIBUTES:
